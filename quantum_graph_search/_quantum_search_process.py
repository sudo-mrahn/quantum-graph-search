"""Supporting helpers for the canonical quantum-search modules."""

import numpy as np

from quantum_graph_search.graph import degrees_of
from quantum_graph_search._validation import (
    require_probability,
    require_square_array,
    require_vertex_index,
)
...
def search_times(prob, prop):
    ...
    prop = require_probability("prop", prop)
